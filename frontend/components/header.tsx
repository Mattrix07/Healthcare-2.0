          ...
          <div>
            <div className="flex flex-wrap items-center gap-3">
              <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">
                Australian Private Health Review
              </h1>
            ...
            <p className="mt-2 text-sm text-blue-100/90 max-w-2xl">
              Multi-agent pre-admission funding review for Australian private health insurers, aligning clinical notes, MBS-style item numbers, member cover, hospital contracting and human reviewer sign-off.
            </p>
            <div className="mt-3 flex flex-wrap items-center gap-1.5 text-xs text-blue-200/80">
              <Sparkles className="h-3 w-3" />
              <span>Member eligibility</span>
              <span className="mx-1">&#183;</span>
              <span>MBS item review</span>
              <span className="mx-1">&#183;</span>
              <span>Hospital pathway triage</span>
            </div>
          </div>
        </div>
      </div>
